    ...
    return (
        ...
        >
            <VStack spacing="4" align="stretch">
                <Button w={'100%'} p={2} gap={2} bgColor={'yellow.400'} variant="ghost" onClick={toggleSidebar}><Icon fontSize={26}><TbDog /></Icon>{isExpanded ? 'Guilda do dog caramelo' : '' }</Button>
                {isExpanded ? (
                    <>
                        <Link to="/" style={{ textDecoration: 'none' }}>
                            <Button w={'100%'}  gap={2} bgColor={'yellow.400'} variant="ghost">
                        ...
                        <>
                            <Link to="/" style={{ textDecoration: 'none' }}>
                                <Button w={'100%'} _hover={{ backgroundColor: 'yellow.500' }} bgColor={'yellow.400'} variant="ghost" >
                                    <Icon fontSize={22}><FaHome /></Icon>
                                </Button>
                            </Link>
                            <Link to="/warriors" style={{ textDecoration: 'none' }}>
